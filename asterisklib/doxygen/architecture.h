...
definition in <code>include/asterisklib/translate.h</code>.
...
definition in <code>include/asterisklib/file.h</code>.
...
<code>include/asterisklib/channel.h</code>.
...
\arg <code>include/asterisklib/bridge.h</code>
\arg <code>include/asterisklib/bridge_technology.h</code>
\arg <code>include/asterisklib/bridge_channel.h</code>
\arg <code>include/asterisklib/bridge_features.h</code>
\arg <code>include/asterisklib/bridge_after.h</code>
...
<code>include/asterisklib/cdr.h</code>.
...
<code>include/asterisklib/cel.h</code>.
...
<code>include/asterisklib/pbx.h</code>.
...
see <code>include/asterisklib/pbx.h</code>.
...
For additional information on the timing API, see <code>include/asterisklib/timing.h</code>.
...
For example, the event API (include/asterisklib/event.h) uses a thread internally
(main/event.c) to handle asychronous event dispatching.  The devicestate API
(include/asterisklib/devicestate.h) uses a thread internally (main/devicestate.c)
...
<code>exten => 5551212,n,Dial(IAX2/mypeer)</code><br/>
 ...
 -# <b>Execute Dial()</b>: The only step in this dialplan is to execute the
    ...
    -# <b>Create an Outbound Channel:</b> The <code>Dial()</code> application needs to
       ...
       is a part of the core channel API (include/asterisklib/channel.h).  It will find
...
include/asterisklib/astobj2.h.  Some internal implementation details for astobj2 can
...
are defined in include/asterisklib/dlinkedlists.h.

\subsection ArchHeap Heap

Asterisk provides an implementation of the max heap data structure.  The API is defined
in include/asterisklib/heap.h.  The internal implementation details can be found in
main/heap.c.
...
The definitions of these wrappers can be found in <code>include/asterisklib/lock.h</code>
and <code>include/asterisklib/utils.h</code>.  Most of the implementation details can be
...
in <code>include/asterisklib/utils.h</code>.  By default, all of these wrappers use the
